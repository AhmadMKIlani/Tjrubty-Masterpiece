...
<body>
  	...
  	<label for="menu-icon" class="res-menu"></label>
  	<nav class="nav res-menu"> 		
  		<ul class="pt-5">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="container d-flex align-items-center">
      <button class="navbar-toggler" style="display:none;" type="button" data-toggle="collapse" data-target="#ftco-nav"
      ...
      <div class="collapse navbar-collapse " id="ftco-nav">
        <ul class="navbar-nav mr-auto float-right">
          ...
          <li class="nav-item"><a href="{{ route('services' )}}" class="nav-link">Services</a></li>
          <li class="nav-item "><a href="{{  route('about' ) }}" class="nav-link" style="margin-right:80px;">About</a>
          </li>
          @guest
          @if (Route::has('login'))
  ...
  <section class="home-slider owl-carousel">
    ...
    @for ($i = 1; $i <= 4; $i++) <div class="slider-item"
      style="background-image:url('/storage/public_site/banner{{ $i }}.jpg') ; background-position: center; background-size: cover; ">
